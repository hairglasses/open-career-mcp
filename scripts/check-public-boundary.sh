...
go run ./cmd/open-career-mcp opportunities list > "$tmp_dir/opportunities.txt"
go run ./cmd/open-career-mcp resume tailor --opportunity syn-001 > "$tmp_dir/tailor.txt"
go run ./cmd/open-career-mcp interview prep --opportunity syn-001 > "$tmp_dir/interview.txt"
go run ./cmd/open-career-mcp mcp manifest > "$tmp_dir/manifest.json"
go run ./cmd/open-career-mcp mcp call open_career_tailor_resume --param opportunity_id=syn-001 > "$tmp_dir/mcp-tailor.json"
